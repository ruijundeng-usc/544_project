...
class Config:
    CODELAB = '/content/drive/MyDrive/Colab Notebooks/544_bart/plan_write_codelab/'
    # DataRootPath = './data/'
    # ModelRootPath = './model'
    # ResultRootPath = './result'
    DataRootPath = CODELAB + 'data/'
    ModelRootPath = CODELAB + 'model/'
    ResultRootPath = CODELAB + 'result/'
    Title2Line = {
        # data
    ...
    Line2Story = {
        ...
        'testset': os.path.join(ResultRootPath, 'title2line_fortest.tsv'),
